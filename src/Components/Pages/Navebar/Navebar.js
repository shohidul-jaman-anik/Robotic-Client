            ...
            <div className='col-lg-8 col-12'>
              <div className='row align-items-center'>
                <div className='col-lg-4 col-md-5'>
                  <p><FontAwesomeIcon icon={faGlobe} /> <span className='subHeader'>We work with global Industry</span></p>
                </div>
                <div className='col-lg-3 col-md-3'>
                  <p><FontAwesomeIcon icon={faEnvelope} /> <span className='subHeader'>hello@robtic.com</span></p>
                </div>
